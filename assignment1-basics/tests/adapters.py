...
from cs336_basics.fake_pytorch import Linear, Embedding, RMSNorm, SwiGLU, RoPE, softmax, scaled_dot_product_attention
...
def run_rope(
    ...
    """
    return RoPE(theta=theta, d_k=d_k, max_seq_len=max_seq_len).forward(x=in_query_or_key, token_positions=token_positions)
